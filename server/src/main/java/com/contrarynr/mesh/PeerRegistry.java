...
public class PeerRegistry {
    //主机号范围 [1, 254] —— 1 不再为 Coordinator 保留:Java 端只做信令中介,不参与组网,没有自身主机号
    //(与 util.h 必须逐位一致)
    ...
    SHA-256 取第 4~7 字节(大端)拼成无符号 32 位整数, mod 254 后 +1, 映射到 [1, 254]*/
    ...
    //与 util.h::resolveHostNumCollision 一致: 从 base 起自增 1, 跳过已占用的号
